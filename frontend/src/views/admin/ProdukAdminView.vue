...
// Data Produk Sample
const products = ref([
  { id: 1, name: 'Basreng Pedas Jeruk', category: 'Camilan Pedas', price: 'Rp 15.000', stock: 45 },
  { id: 2, name: 'Keripik Kaca Original', category: 'Keripik', price: 'Rp 12.000', stock: 30 },
  { id: 3, name: 'Makaroni Level 5', category: 'Camilan Pedas', price: 'Rp 10.000', stock: 60 }
])
      ...
      <main class="content-body">
        ...
        <div class="dashboard-banner">
          <div class="banner-content">
            ...
            <button class="btn-primary-action">+ Tambah Produk Baru</button>
          </div>
        </div>
