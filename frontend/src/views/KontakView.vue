...
<template>
  <div class="about-wrapper">
    ...
    <!-- HERO KONTAK PREMIUM WITH GLOW EFFECTS -->
    <section class="about-hero">
      ...
      <div class="container hero-container">
        <div class="hero-content">
          ...
          <h1 class="hero-title">
            Ada yang Ingin<br>
            <span class="gradient-text">Ditanyakan?</span>
          </h1>
          <p class="hero-subtitle">
            Jangan ragu untuk menghubungi kami. Tim Cemilku siap membantu Anda mengenai informasi produk, pemesanan, maupun kendala lainnya.
          </p>
        ...
        <div class="hero-visual">
          <div class="hero-card-3d">
            ...
            <h3 class="brand-title">Customer Support</h3>
            <p class="brand-tagline">Fast Response CS</p>
    ...
    <section class="container story-section">
      <div class="contact-grid">
        <div class="story-card hover-lift">
          ...
          <span class="story-badge">WHATSAPP CHAT</span>
          <h2>Layanan Pesan Instan</h2>
          <p>
            Respon paling cepat untuk pertanyaan stok produk, konsultasi varian cemilan, hingga pemesanan langsung.
          </p>
          <div class="card-action-box">
            <button class="btn-primary btn-card-fit" @click="openWhatsApp">
              Hubungi WhatsApp &rarr;
            </button>
          </div>
        </div>
        ...
        <div class="story-card hover-lift">
          ...
          <span class="story-badge">EMAIL SUPPORT</span>
          <h2>Dukungan Email</h2>
          <p>
            Kirimkan pertanyaan resmi, kendala transaksi, atau tawaran kerja sama bisnis melalui alamat email resmi kami.
          </p>
          <div class="card-action-box">
            <a href="mailto:cemilku@example.com" class="btn-outline btn-card-fit">
              Kirim Email &rarr;
            </a>
          </div>
        </div>
    ...
    <!-- HIGHLIGHT STATS / TRUST BAR -->
    <section class="container stats-container">
      <div class="stats-card">
        <div class="stat-item">
          <h2>01</h2>
          <p>Respon Cepat & Sigap</p>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          <h2>02</h2>
          <p>Bantuan Pemesanan 24/7</p>
        </div>
        <div class="stat-divider"></div>
        <div class="stat-item">
          <h2>03</h2>
          <p>Kritik & Saran Terbuka</p>
        </div>
      </div>
    </section>
